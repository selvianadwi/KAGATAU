                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-dark text-nowrap">
                            <tr>
                                ...
                                <th class="text-center py-3">Status & Update Foto</th>
                        ...
                        <tbody>
                            @forelse($layanans as $l)
                                @php
                                    ...
                                    $waSettings = file_exists($jsonPath)
                                        ...
                                        : [];
                                    $rawMessage =
                                        $waSettings['wa_template'] ?? 'Layanan KAGATAU: Tahanan [nama_tahanan]...';
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($l->screenshot)
                                            <button type="button" class="btn btn-sm btn-outline-info px-2 py-1"
                                                data-bs-toggle="modal" data-bs-target="#modalSS{{ $l->id }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content border-0">
                                                        <div class="modal-header bg-info text-white">
                                                            <h6 class="modal-title">Screenshot WA</h6><button type="button"
                                                                class="btn-close btn-close-white"
                                                                data-bs-dismiss="modal"></button>
                                                        </div>
                                                        <div class="modal-body bg-light text-center"><img
                                        ...
                                        @else
                                            <span
                                                class="badge bg-danger-subtle text-danger border border-danger-subtle small">Belum</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center">
                                        @if ($l->dokumentasi)
                                            <button type="button" class="btn btn-sm btn-outline-primary px-2 py-1"
                                                data-bs-toggle="modal" data-bs-target="#modalDok{{ $l->id }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content border-0">
                                                        <div class="modal-header bg-primary text-white">
                                                            <h6 class="modal-title">Foto Dokumentasi</h6><button
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            {{-- WhatsApp --}}
                                            {{-- Tombol WhatsApp (Sekarang gaya Outline & Border-0) --}}
                                            <a href="{{ $urlWA }}" target="_blank"
                                                onclick="setTimeout(function(){ window.location.href='{{ route('layanan.layani', $l->id) }}'; }, 500);"
                                                class="btn btn-outline-success btn-sm border-0 shadow-none"
                                                title="Layani via WA">
                                                <i class="bi bi-whatsapp"></i>
                                            </a>

                                            {{-- EDIT DATA (Route Baru edit2) --}}
                                            <a href="{{ route('layanan.edit2', $l->id) }}"
                                                class="btn btn-outline-primary btn-sm border-0" title="Edit Informasi">
                            ...
                            @empty
                                <tr>
                                    <td colspan="11" class="text-center py-5 text-muted small italic">Belum ada antrean
                                        hari ini.</td>
                                </tr>
                            @endforelse
                        </tbody>
